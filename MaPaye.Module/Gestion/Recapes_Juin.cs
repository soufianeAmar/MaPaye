...
namespace MaPaye.Module
{
    ...
    [DefaultClassOptions]
    public class Recapes_Juin : BaseObject
    {

        private Recape_Annuelle recape_Annuelle_Juin;
        [Association("Recape_Annuelle_Juin-Recapes_Juin", typeof(Recape_Annuelle))]
        public Recape_Annuelle Recape_Annuelle_Juin
        {
            get { return recape_Annuelle_Juin; }
            set
            {
                SetPropertyValue("Recape_Annuelle_Juin", ref recape_Annuelle_Juin, value);
            }
        }
        ...
        public Recapes_Juin(Session session)
            : base(session)
        {
