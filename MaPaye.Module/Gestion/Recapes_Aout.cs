...
namespace MaPaye.Module
{
    ...
    [DefaultClassOptions]
    public class Recapes_Aout : BaseObject
    {

        private Recape_Annuelle recape_Annuelle_Aout;
        [Association("Recape_Annuelle_Aout-Recapes_Aout", typeof(Recape_Annuelle))]
        public Recape_Annuelle Recape_Annuelle_Aout
        {
            get { return recape_Annuelle_Aout; }
            set
            {
                SetPropertyValue("Recape_Annuelle_Aout", ref recape_Annuelle_Aout, value);
            }
        }
        ...
        public Recapes_Aout(Session session)
            : base(session)
        {
