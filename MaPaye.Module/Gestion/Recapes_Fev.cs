...
namespace MaPaye.Module
{
    ...
    [DefaultClassOptions]
    public class Recapes_Fev : BaseObject
    {
          
        private Recape_Annuelle recape_Annuelle_Fev;
        [Association("Recape_Annuelle_Fev-Recapes_Fev", typeof(Recape_Annuelle))]
        public Recape_Annuelle Recape_Annuelle_Fev
        {
            get { return recape_Annuelle_Fev; }
            set
            {
                SetPropertyValue("Recape_Annuelle_Fev", ref recape_Annuelle_Fev, value);
            }
        ...
        public Recapes_Fev(Session session)
            : base(session)
        {
