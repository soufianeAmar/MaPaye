...
namespace MaPaye.Module
{
    ...
    [DefaultClassOptions]
    public class Recapes_Juill : BaseObject
    {

        private Recape_Annuelle recape_Annuelle_Juill;
        [Association("Recape_Annuelle_Juill-Recapes_Juill", typeof(Recape_Annuelle))]
        public Recape_Annuelle Recape_Annuelle_Juill
        {
            get { return recape_Annuelle_Juill; }
            set
            {
                SetPropertyValue("Recape_Annuelle_Juill", ref recape_Annuelle_Juill, value);
            }
        }
        ...
        public Recapes_Juill(Session session)
            : base(session)
        {
