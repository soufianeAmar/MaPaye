...
namespace MaPaye.Module
{
    ...
    [DefaultClassOptions]
    public class Recapes_Avr : BaseObject
    {

        private Recape_Annuelle recape_Annuelle_Avr;
        [Association("Recape_Annuelle_Avr-Recapes_Avr", typeof(Recape_Annuelle))]
        public Recape_Annuelle Recape_Annuelle_Avr
        {
            get { return recape_Annuelle_Avr; }
            set
            {
                SetPropertyValue("Recape_Annuelle_Avr", ref recape_Annuelle_Avr, value);
            }
        ...
        public Recapes_Avr(Session session)
            : base(session)
        {
