...
namespace MaPaye.Module
{
    ...
    [DefaultClassOptions]
    public class Recapes_Nouv : BaseObject
    {

        private Recape_Annuelle recape_Annuelle_Nouv;
        [Association("Recape_Annuelle_Nouv-Recapes_Nouv", typeof(Recape_Annuelle))]
        public Recape_Annuelle Recape_Annuelle_Nouv
        {
            get { return recape_Annuelle_Nouv; }
            set
            {
                SetPropertyValue("Recape_Annuelle_Nouv", ref recape_Annuelle_Nouv, value);
            }
        }
        ...
        public Recapes_Nouv(Session session)
            : base(session)
        {
