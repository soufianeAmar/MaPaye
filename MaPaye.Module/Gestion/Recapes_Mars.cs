...
namespace MaPaye.Module
{
    ...
    [DefaultClassOptions]
    public class Recapes_Mars : BaseObject
    {
 
        private Recape_Annuelle recape_Annuelle_Mars;
        [Association("Recape_Annuelle_Mars-Recapes_Mars", typeof(Recape_Annuelle))]
        public Recape_Annuelle Recape_Annuelle_Mars
        {
            get { return recape_Annuelle_Mars; }
            set
            {
                SetPropertyValue("Recape_Annuelle_Mars", ref recape_Annuelle_Mars, value);
            } 
        }
        ...
        public Recapes_Mars(Session session)
            : base(session)
        {
