...
namespace MaPaye.Module
{
    ...
    [DefaultClassOptions]
    public class Recapes_Sept : BaseObject
    {

        private Recape_Annuelle recape_Annuelle_Sept;
        [Association("Recape_Annuelle_Sept-Recapes_Sept", typeof(Recape_Annuelle))]
        public Recape_Annuelle Recape_Annuelle_Sept
        {
            get { return recape_Annuelle_Sept; }
            set
            {
                SetPropertyValue("Recape_Annuelle_Sept", ref recape_Annuelle_Sept, value);
            }
        }
        ...
        public Recapes_Sept(Session session)
            : base(session)
        {
