...
namespace MaPaye.Module
{
    ...
    [DefaultClassOptions]
    public class Recapes_Dec : BaseObject
    {

        private Recape_Annuelle recape_Annuelle_Dec;
        [Association("Recape_Annuelle_Dec-Recapes_Dec", typeof(Recape_Annuelle))]
        public Recape_Annuelle Recape_Annuelle_Dec
        {
            get { return recape_Annuelle_Dec; }
            set
            {
                SetPropertyValue("Recape_Annuelle_Dec", ref recape_Annuelle_Dec, value);
            }
        }
        ...
        public Recapes_Dec(Session session)
            : base(session)
        {
