...
namespace MaPaye.Module
{
    ...
    [DefaultClassOptions]
    public class Recapes_Mai : BaseObject
    {

        private Recape_Annuelle recape_Annuelle_Mai;
        [Association("Recape_Annuelle_Mai-Recapes_Mai", typeof(Recape_Annuelle))]
        public Recape_Annuelle Recape_Annuelle_Mai
        {
            get { return recape_Annuelle_Mai; }
            set
            {
                SetPropertyValue("Recape_Annuelle_Mai", ref recape_Annuelle_Mai, value);
            }
        }
        ...
        public Recapes_Mai(Session session)
            : base(session)
        {
