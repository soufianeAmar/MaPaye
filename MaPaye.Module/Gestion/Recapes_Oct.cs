...
namespace MaPaye.Module
{
    ...
    [DefaultClassOptions]
    public class Recapes_Oct : BaseObject
    {

        private Recape_Annuelle recape_Annuelle_Oct;
        [Association("Recape_Annuelle_Oct-Recapes_Oct", typeof(Recape_Annuelle))]
        public Recape_Annuelle Recape_Annuelle_Oct
        {
            get { return recape_Annuelle_Oct; }
            set
            {
                SetPropertyValue("Recape_Annuelle_Oct", ref recape_Annuelle_Oct, value);
            }
        }
        ...
        public Recapes_Oct(Session session)
            : base(session)
        {
