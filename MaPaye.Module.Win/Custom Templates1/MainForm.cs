...
namespace DevExpress.ExpressApp.Win.CustomTemplates {
    public partial class MainForm : MainFormTemplateBase, IDockManagerHolder, IXafDocumentsHostWindow, ISupportClassicToRibbonTransform
    {
        ...
        protected override void UpdateMdiModeDependentProperties() {
            ...
            bool isMdi = UIType == UIType.StandardMDI;
